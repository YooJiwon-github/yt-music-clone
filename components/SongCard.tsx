  ...
  return (
    <article className='flex flex-row items-center gap-4 h-[48px] w-full
     relative group'>
        ...
        <div className=' flex flex-row item gap-4'>
            <div>
        ...
        <section className=' hidden group-hover:flex absolute top-0 right-0 left-0 flex-row justify-end items-center h-[48px] w-1/2 bg-[rgba(0,0,0,0.7)]'>
